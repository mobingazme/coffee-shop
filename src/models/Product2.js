...
function Product2 (){
    return(
        ...
        <div className=' w-80 flex flex-col md:shadow md:hover:shadow-lg'>
          <div className='bg-red-600 rounded-t-xl rounded-br-3xl w-80 h-40 '>
            ...
            <h4 className='text-4xl flex justify-center '>147$</h4>
          </div>
          <div className='flex flex-col  items-center  '>
            ...
            <button className='bg-greay  hover:bg-yellow w-40 h-14 md:h-10 rounded-full transition-all delay-100'>پرداخت</button>
        ...
        <div className=' w-80 flex flex-col md:shadow md:hover:shadow-lg mt-6 md:mt-0'>
          ...
          <div className='flex flex-col  items-center'>
            ...
            <h4 className='text-gray-800 md:text-sm py-8 md:py-5  '>آموزش ساخت قهوه</h4>
            <h4 className='text-gray-800 md:text-sm  pb-5'>آموزش فروش قهوه</h4>
            <button className='bg-greay  hover:bg-yellow w-40 h-14 md:h-10 rounded-full mb-2 transition-all delay-100 '>پرداخت</button>
